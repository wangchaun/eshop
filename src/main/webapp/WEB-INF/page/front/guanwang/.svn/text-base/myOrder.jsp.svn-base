...
<li><a href="${ctx }/shippedGoods.do?saleOrder.deliveryState=1">已取货商品<span>(<samp>${deliveryOrder }</samp>)</span></a></li>
<li><a href="${ctx }/shippedGoods.do?saleOrder.deliveryState=0">未取货商品<span>(<samp>${deliveryOrder2 }</samp>)</span></a></li>
