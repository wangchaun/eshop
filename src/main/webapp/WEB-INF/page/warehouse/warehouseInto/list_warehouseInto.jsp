...
<head>
    ...
    <script type="text/javascript" src="${ctx }/scripts/warehouse/warehouseInto/list_warehouseInto.js"></script>
    ...
    <table border="0" cellpadding="0" cellspacing="1" class="gdcn-table-bgcolor" width="100%" style="font-size: 12px;">
        <tr>
            ...
            <td class='gridtitle'>
                ...
                <a id="btnAudit" href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-reload"
                   onclick="cancelSearch()">清空</a>
            </td>
        </tr>
    </table>
</div>
