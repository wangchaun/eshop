					...
					<form id="saveForm" method="post" action="">
				    	...
				    	<table width="100%"  border="0" cellpadding="0" cellspacing="1" class="gdcn-table-bgcolor">
					    	<tr>
								...
								<td class='gridbody'>					
									<input type="text" id="code" name="dictionary.code" maxlength="20" value="${dictionary.code}" onchange="codeCheck()" /><font color="red">*</font>
								</td>
							</tr>
							<tr>
								<td class='gridtitle'>目录名称：</td>
								<td class='gridbody'>
									<input type="text" id="name" name="dictionary.name" maxlength="20" value="${dictionary.name}"/><font color="red">*</font>
								</td>
							</tr>
							<tr>
								<td class='gridtitle'>序号：</td>
								<td class='gridbody'>
									<input type="text" id="sort" name="dictionary.sort" maxlength="20" value="${dictionary.sort}"/><font color="red">*</font>
								</td>
							</tr>
						</table>
