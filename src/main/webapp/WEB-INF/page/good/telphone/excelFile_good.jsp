...
<html>
	...
	function getExcelDate() {
		...
		if(confirm("你确定要导入吗?")){
			$.ajax({
				  ...
				  async: false,
				  cache: false,
				  url: ctx+"/telphone!getExcelDate.do",
				  ...
				  success : function(returnData){
						if(returnData == 'true'){
							...
							sleep(3000);
							window.parent.location.href = ctx+"/phone.jsp";
  ...
  <body>
    	...
    	<div id="loading" align="center" style="display:none">
    		<img src="${ctx}/styles/loading30.gif"/><br/><br/><br/><span style="color:red;font-size:16px;">数据在导入,请耐心等待</span>
    	</div>
  </body>
</html>
