...
<head>
	...
	<script type="text/javascript" src="${ctx }/scripts/store/gift/list_gift.js"></script>
	...
	<div style="margin-top: 10px; margin-bottom: 5px;">
		<table border="0" cellpadding="0"  cellspacing="1" class="gdcn-table-bgcolor" width="100%" style="font-size: 12px;">
			<tr>
				...
				<td class='gridtitle'>礼品包名称：</td>
				<td class='gridbody'><input type="text" id="giftName" onkeydown="checkKey()" /></td>
				<td class='gridtitle'>
