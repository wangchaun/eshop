...
<head>
	...
	<script type="text/javascript" src="${ctx }/scripts/order/sale/saleReturn/list_saleReturn.js"></script>
	...
	<div style="margin-top: 10px; margin-bottom: 5px;">
		<table border="0" cellpadding="0"  cellspacing="1" class="gdcn-table-bgcolor" width="100%" style="font-size: 12px;">
			<tr>
				...
				<td class='gridbody'><input type="text" id="remark" onkeydown="checkKey()" /></td>
				<td class='gridtitle'> 
